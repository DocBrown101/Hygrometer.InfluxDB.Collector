...
namespace Hygrometer.InfluxDB.Collector.Model
{
    public class CollectorConfiguration
    {
        ...
        private void SetDefaultValues()
        {
            ...
            this.influxDbUrl.DefaultValue = "http://192.168.0.220:8428";
            this.influxDbOrg.DefaultValue = "org";
            this.influxDbBucket.DefaultValue = "bucket";
            this.influxDbMeasurement.DefaultValue = "minisolar";
